...
function divider(numbersArray) {
  ...
  for (var i = 0; i < numbersArray.length; i++) {
    if (numbersArray[i] % 2 !== 1) {
      ...
      oddNum.push(numbersArray[i])
    }
  }
  numArray.push(evenNum, oddNum)
  return numArray;
...
function addTen(arr) {
  ...
  for (var i = 0; i < arr.length; i++) {
    numbArr.push(parseInt(arr[i]) + 10);
  }
  return numbArr;
}
...
var user2 = {
  ...
  email: 'BM@gmail.com',
  password: 'abc123',
  username: 'clevernamehere'
};
var user3 = {
  name: 'Tom Folden',
  email: 'TFolden@gmail.com',
  password: 'catsarelife',
  username: 'coderightmeow'
};
